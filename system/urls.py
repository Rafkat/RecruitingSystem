...
urlpatterns = [
    ...
    path('recruitform/', views.CreateRecruit.as_view(), name='NewRecruit'),
    path('saverecruit/', views.CreateRecruit.as_view(), name='SaveRecruit'),
    path('testrecruit/<int:id>/', views.TestRecruit.as_view(), name='TestRecruit'),
    path('savetest/', views.TestRecruit.as_view(), name='SaveTest'),
